-- 2차 프로젝트 DB 구축
-- 25.07.28 MON 작성 / 25.08.01 FRI 수정
...
(
	predict_seq bigint            PRIMARY KEY AUTO_INCREMENT,
	user_id     varchar(50)       NOT NULL,
	vessel_alias varchar(100)     NOT NULL,
...
-- DELETE FROM port_predict;
COMMIT;


-- 6-1. 항구명 (0) (port_info 부터 생성)
...
(
	pso_seq bigint      PRIMARY KEY AUTO_INCREMENT,
	port_id varchar(10) NOT NULL,
	pso_lat decimal(15, 10) NOT NULL,
	pso_lon decimal(15, 10) NOT NULL,
		FOREIGN KEY (port_id) REFERENCES port_info(port_id)
);
